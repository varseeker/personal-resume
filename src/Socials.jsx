...
const ROLES = [
  { text: "NETWORK", color: "#e8c100", bg: "rgba(232,193,0,0.12)", border: "rgba(232,193,0,0.5)" },
  { text: "CODE", color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
  { text: "MEDIA", color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
];
...
const ITEMS = [
  {
    id: "linkedin",
    label: "LINKEDIN",
    handle: "@muhammad-ibad-ahsan",
    href: "https://www.linkedin.com/in/muhammad-ibad-ahsan",
    icon: "💼",
    barIcon: icon1,
    bars: 1,
    newBars: [],
    counts: ["OPEN"],
    links: ["linkedin.com/in/muhammad-ibad-ahsan"],
    stats: [
      { tag: "NET", value: "IN", color: "#0a66c2" },
      { tag: "TIP", value: "↵", color: "#71b7fb" },
    ],
  },
  {
    id: "github",
    label: "GITHUB",
    handle: "@varseeker",
    href: "https://github.com/varseeker",
    icon: "◇",
    barIcon: icon2,
    bars: 1,
    newBars: [],
    counts: ["OPEN"],
    links: ["github.com/varseeker"],
    stats: [
      { tag: "SRC", value: "GH", color: "#f0f6fc" },
      { tag: "TIP", value: "↵", color: "#8b949e" },
    ],
  },
  {
    id: "instagram",
    label: "INSTAGRAM",
    handle: "@ahsn.yure",
    href: "https://www.instagram.com/ahsn.yure",
    icon: "📷",
    barIcon: icon3,
    bars: 1,
    newBars: [],
    counts: ["OPEN"],
    links: ["instagram.com/ahsn.yure"],
    stats: [
      { tag: "MED", value: "IG", color: "#e1306c" },
      { tag: "TIP", value: "↵", color: "#f77737" },
    ],
  },
];
