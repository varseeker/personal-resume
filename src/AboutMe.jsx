...
const REVEAL_CONTENT = [
  {
    upper: ["Muhammad Ibadurrahman Al-ahsan", "Software Engineer"],
    lower: "fullstack developer • spring • react • angular • node • .net • laravel",
  },
  {
    upper: [
      "Strong interest in tech for online business & marketplace systems.",
      "Personal time: reading and listening to music.",
    ],
    lower: "adapt quickly to new tools, teams, and environments",
  },
  {
    upper: [
      "a versatile or fullstack software developer",
      "with a strong foundation in Java, JavaScript/TypeScript, Node.js, Go-Lang, Python, C#, and PHP.",
    ],
    lower: "building across web backends, front ends, and mobile",
  },
];
...
const ROLES = [
  ...
  { text: "CRAFT", color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
];

const ITEMS = [
  { id: "intro", label: "ABOUT ME" },
  { id: "life", label: "INTERESTS & LIFE" },
  { id: "stack", label: "STACK & PRINCIPLES" },
];
...
export default function AboutMe() {
  ...
  return (
    <div id="menu-screen">
      <video src={bgVideo} autoPlay loop playsInline />
      ...
      {revealed && (
        <div key={`panel-${active}`} className={`sc-reveal-panel${mounted ? " mounted" : ""}`}>
          ...
          <div className="sc-reveal-lower-bar">
            <span className="sc-reveal-lower-text">{REVEAL_CONTENT[active].lower}</span>
          </div>
        </div>
      )}
      {revealed && (
      ...
      <style>{`
        ...
        /* Video sits under .sc-root; disable hits so gaps/edges don’t steal hover from bars */
        #menu-screen > video {
          pointer-events: none;
        }
